...
class MainWin(QtGui.QDialog):
	...
	def init_widgets(self):
		...
		button_runAudio = QtGui.QPushButton(tr('Play Audio'))
		button_runAudio.clicked.connect(self.slot_audio)
		button_runVideo = QtGui.QPushButton(tr('Play Video'))
		button_runVideo.clicked.connect(self.slot_video)
		button_runDirectory = QtGui.QPushButton(tr('Open Directory'))
		button_runDirectory.clicked.connect(self.slot_dir)
		button_addItunes = QtGui.QPushButton(tr('Add to iTunes'))
		...
		button_addPlaylist = QtGui.QPushButton(tr('Add to a Playlist'))
