...
os.system('xcopy * build\\src\\')
os.system('xcopy /S code build\\src\\code\\')
os.system('xcopy /S testcode build\\src\\testcode\\')
...
os.chdir(r"C:\Scripts\iQuality\build\src")
os.system('del /F /S /Q Thumbs.db')
os.system('del /F /S /Q *.log*')
os.system('del /F /S /Q *pylint.txt')
os.system('del /F /S /Q *.ini')
os.system('del /F /S /Q *.rar')
os.system('del /F /S /Q *.zip')
os.system('del /F /S /Q *.tmp')
os.system('del /F /S /Q *.bat')
os.system('del /F /S /Q *.pyc')
os.system('del /F /S /Q *.pyd')
os.system('del /F /S /Q *.pyo')
os.chdir(r"C:\Scripts\iQuality")
